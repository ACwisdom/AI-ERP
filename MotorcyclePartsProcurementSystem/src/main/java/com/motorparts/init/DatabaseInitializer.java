...
public class DatabaseInitializer implements ApplicationRunner {
    ...
    private void createDatabase() {
        try {
            // 创建数据库
            jdbcTemplate.execute("CREATE DATABASE IF NOT EXISTS motorparts_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
    ...
    private void createTables() {
        ...
        jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS `user` (" +
                ...
                ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户/员工表'");
        ...
        jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS `part` (" +
                ...
                ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='产品/零部件表'");
